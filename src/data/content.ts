...
export const money = {
  ...
  ledgerTotals: { owed: 7664.98, paid: 2986.01, diff: 4873.78 },
  ledger: [
    { name: "Dustin O'Reilly", owed: 603.54, paid: 300, diff: 303.54 },
    { name: 'Wilder Heuga', owed: 603.54, paid: 603.54, diff: 0 },
    { name: 'Derek Vanwagner', owed: 603.54, paid: 0, diff: 603.54 },
    { name: 'Nick Cantelmi', owed: 603.54, paid: 0, diff: 603.54 },
    { name: 'Tony Savino', owed: 603.54, paid: 0, diff: 603.54 },
    { name: 'The Hamm Master', owed: 603.54, paid: 1100, diff: -496.46 },
    { name: 'Matt Albrecht', owed: 603.54, paid: 0, diff: 603.54 },
    { name: 'Matt Wilson', owed: 603.54, paid: 0, diff: 603.54 },
    { name: 'William Scheffler', owed: 603.54, paid: 0, diff: 603.54 },
    { name: 'Brian Wagner', owed: 888.54, paid: 982.47, diff: -93.93 },
    { name: 'Carlos Garcia', owed: 603.54, paid: 0, diff: 603.54 },
