...
export const money = {
  ...
  lineItems: [
    { item: 'Airbnb (4842 Meadow Lane)', perPerson: '$420.81', amount: '$5,049.71' },
    { item: 'Dinner at El Segundo', perPerson: '$69.38', amount: '$1,110.00' },
    { item: 'Transportation (shuttle)', perPerson: '$57.31', amount: '$745.00' },
  ...
  ledgerTotals: { owed: 7865.99, paid: 2986.63, diff: 4879.36 },
  ledger: [
    { name: "Dustin O'Reilly", owed: 604.16, paid: 300, diff: 304.16 },
    { name: 'Wilder Heuga', owed: 604.16, paid: 604.16, diff: 0 },
    { name: 'Derek Vanwagner', owed: 604.16, paid: 0, diff: 604.16 },
    { name: 'Nick Cantelmi', owed: 604.16, paid: 0, diff: 604.16 },
    { name: 'Tony Savino', owed: 604.16, paid: 0, diff: 604.16 },
    { name: 'The Hamm Master', owed: 604.16, paid: 1100, diff: -495.84 },
    { name: 'Matt Albrecht', owed: 604.16, paid: 0, diff: 604.16 },
    { name: 'Matt Wilson', owed: 604.16, paid: 0, diff: 604.16 },
    { name: 'William Scheffler', owed: 604.16, paid: 0, diff: 604.16 },
    { name: 'Brian Wagner', owed: 888.54, paid: 982.47, diff: -93.93 },
    { name: 'Carlos Garcia', owed: 604.16, paid: 0, diff: 604.16 },
    { name: 'Hunter Snyder', owed: 534.79, paid: 0, diff: 534.79 },
    ...
    { name: 'Adam Ranken', owed: 57.31, paid: 0, diff: 57.31 },
